...
In diesem Beispiel wird ein Rust-Webserver im Container (mittels Actix-web) gestartet und Zugriffspunkte (Pfade) definiert. Darüber hinaus wird ein 'MariaDB'-Datenbankcontainer angelegt, welcher vom Webserver verwendet wird.
